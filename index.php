	...
	<section class="main">
		...
		<h2>Productos Destacados</h2>
			...
			<div class="productos destacados">
				<center>
					...
					<span class="precio"><strong>Precio: </strong><?php echo $precio[1]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[1]?>" class="ver">Ver producto</a><br>
					</div>
					...
					<span class="precio"><strong>Precio: </strong><?php echo $precio[10]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[10]?>" class="ver">Ver producto</a><br>
					</div>
					...
					<span class="precio"><strong>Precio: </strong><?php echo $precio[13]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[13]?>" class="ver">Ver producto</a><br>
					</div>
					...
					<span class="precio"><strong>Precio: </strong><?php echo $precio[5]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[5]?>" class="ver">Ver producto</a><br>
					</div>
				</center>
			</div>
		...
		<div class="productos oferta">
				<center>
					...
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[3]?>">
						<img class="alto" src="<?php echo $imagen[3]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[3]?>">
						<?php echo "$nombre[3]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[3]/2?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[3]?>" class="ver">Ver producto</a><br>
					</div>
					
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[20]?>">
						<img class="ancha" src="<?php echo $imagen[20]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[20]?>">
						<?php echo "$nombre[20]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[20]/2?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[20]?>" class="ver">Ver producto</a><br>
					</div>
					
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[41]?>">
						<img class="grande" src="<?php echo $imagen[41]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[41]?>">
						<?php echo "$nombre[41]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[41]/2?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[41]?>" class="ver">Ver producto</a><br>
					</div>
					
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[34]?>">
						<img class="alto" src="<?php echo $imagen[34]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[34]?>">
						<?php echo "$nombre[34]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[34]/2?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[34]?>" class="ver">Ver producto</a><br>
					</div>
				</center>
			</div>
		...
		<div class="productos novedades">
				<center>
					...
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[31]?>">
						<img class="alto" src="<?php echo $imagen[31]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[31]?>">
						<?php echo "$nombre[31]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[31]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[31]?>" class="ver">Ver producto</a><br>
					</div>
					
					<div class="producto">
					<a href="detalles.php?=<?php echo $id[32]?>">
						<img class="alto" src="<?php echo $imagen[32]?>"></a><br>
					<span class="nombre"><a href="detalles.php?=<?php echo $id[32]?>">
						<?php echo "$nombre[32]"?></a></span><br>
					<span class="precio"><strong>Precio: </strong><?php echo $precio[32]?> Bs.S</span><br>
					<a href="detalles.php?=<?php echo $id[32]?>" class="ver">Ver producto</a><br>
					</div>
				</center>
			</div>
